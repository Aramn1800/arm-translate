    ...
    <div className="flex flex-col w-full h-full">
      <div className="app-region-drag flex flex-row justify-between items-center w-full h-8 bg-gray-800 p-2">
        <div className="flex flex-row items-center gap-1">
          ...
          <Typography className="text-blue-100 select-none">{`Arm-translate ${title}`}</Typography>
        </div>
        <div className="app-region-no-drag flex flex-row items-center gap-4">
          <IconButton className="p-0" onClick={handleMinimize}>
            <MinimizeIcon className="w-5 h-5 text-blue-100" />
          </IconButton>
          <IconButton className="p-0" onClick={handleClose}>
            <CloseIcon className="w-5 h-5 text-blue-100" />
          </IconButton>
        </div>
      </div>
